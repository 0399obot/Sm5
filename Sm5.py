# Kamu melihat orang dari penampilan, jangan harap usaha anda tercapai,Co By Setiaji.id selalu dihianati oleh seseorang
...
class main:
 def main():
  hyu = str(input(f"{kun}[{kan}•{kun}] {im}Daftar : "))
  if (hyu == '1') or (hyu == '01'):
   os.system("clear")
   bnr()
   main.start()
  elif (hyu == '2') or (hyu == '02'):
   os.system("xdg-open http://Wa.me/+6282324538303")
   main.main()
